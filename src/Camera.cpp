...
void Camera::updateCamera()
{
    ...
    camera_center.x = std::clamp(camera_center.x, WINDOW_WIDTH / 4, WINDOW_WIDTH - WINDOW_WIDTH / 4);
    camera_center.y = std::clamp(camera_center.y, WINDOW_HEIGHT / 4, WINDOW_HEIGHT - WINDOW_HEIGHT / 4);
